...
**Note:** This code works for **Rotational Temperature** in the range ***5&leT*<sub>rot</sub>*&le1000 k***, and the **Kinetic Temperature** in the same range ***5&leT*<sub>kin</sub>*&le1000 k***. 
