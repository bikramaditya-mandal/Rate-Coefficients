...
**Note:** This code works for **Rotational Temperature** in the range ***5&le;T*<sub>rot</sub>*&le;1000 k***, and the **Kinetic Temperature** in the same range ***5&le;T*<sub>kin</sub>*&le;1000 k***. 
